...
import main.by.bsuir.task16.TitleAuthorBookComparator;

import java.util.Comparator;

public class TitleAuthorBookComparatorTest extends BookComparatorTest {
    @Override
    protected Comparator<Book> getComparator() {
        return new TitleAuthorBookComparator();
    }
